...
@Component({
  selector: 'app-consider-options',
  templateUrl: './consider-options.page.html',
  styleUrls: ['./consider-options.page.scss'],
})
export class ConsiderOptionsPage implements OnInit {
  getClass : any;
  backgroundClass: any;
  constructor(
