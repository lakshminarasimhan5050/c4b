...
import { ThoughtJournalModalPage } from '../thought-journal-modal/thought-journal-modal.page';
declare var jQuery;

@Component({
  selector: 'app-thought-journal',
  templateUrl: './thought-journal.page.html',
  styleUrls: ['./thought-journal.page.scss'],
})
export class ThoughtJournalPage implements OnInit {
