...
import { FocusedMeditationModalPage } from '../focused-meditation-modal/focused-meditation-modal.page';
declare var jQuery;

@Component({
  selector: 'app-focused-meditation',
  templateUrl: './focused-meditation.page.html',
  styleUrls: ['./focused-meditation.page.scss'],
})
export class FocusedMeditationPage implements OnInit {
