...
@Component({
  selector: 'app-select-with-intention',
  templateUrl: './select-with-intention.page.html',
  styleUrls: ['./select-with-intention.page.scss'],
})
export class SelectWithIntentionPage implements OnInit {
  getClass : any;
  backgroundClass: any;
  constructor(
      ...
      this.platform.ready().then(() => {
        jQuery(document).ready(function() {
          ...
          jQuery('.rBar a').click(function() {	
            ...
            jQuery("input.br-current-rating").val(rating);
          
            jQuery(this).siblings().removeclass("br-current");	
  ...
  ngOnInit() {
    this.route.queryParams.subscribe(params => {
      if (params && params.special) {
        this.getClass = params.special;
        this.backgroundClass = 'title-'+params.special;
      }
    });
  }
