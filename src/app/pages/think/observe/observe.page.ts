...
import { ObserveModalPage } from '../observe-modal/observe-modal.page';
declare var $;
...
export class ObservePage implements OnInit {
  ...
  ngOnInit() {
    //this.platform.ready().then(() => {
      $("#c1T").css('font-size','0.32em');
      $("#angerMeterTabs").css('display','block');
    //});
  }
  ...
  ionViewWillEnter() {
    ...
    $(document).ready(function() {
      ...
      if ($(this).is(".q1.shrink")) { 
        ...
        var k = $(this).attr('title');
          ...
          $(".q4Kids").css('display','none'); $(".q5Kids").css('display','none'); $(".q6Kids").css('display','none');$(".q7Kids").css('display','none');
          
          $(".q2Kids").removeClass('show');
          $(".q3Kids").removeClass('show');
          $(".q4Kids").removeClass('show'); $(".q5Kids").removeClass('show'); $(".q6Kids").removeClass('show'); $(".q7Kids").removeClass('show'); 		  
      ...
      $('.q2').click(function() {		$(".logoContainer").css('display','none');
        ...
        $(".q2").addClass('active');
          ...
          $(".q3Kids").css('display','none');
          $(".q4Kids").css('display','none');$(".q5Kids").css('display','none');$(".q6Kids").css('display','none');
          
          $(".q1Kids").removeClass('show');
          $(".q3Kids").removeClass('show');
          $(".q4Kids").removeClass('show');  $(".q5Kids").removeClass('show');  $(".q6Kids").removeClass('show'); 
      ...
      $('.q3').click(function() {	   	$(".logoContainer").css('display','none');
      ...
      $('.q4').click(function() {	 	$(".logoContainer").css('display','none');
        ...
        $(this).siblings().removeClass('active');
          ...
          $(".q1Kids").css('display','none');
          $(".q2Kids").css('display','none');
          $(".q3Kids").css('display','none');$(".q5Kids").css('display','none');$(".q6Kids").css('display','none');
          
          $(".q1Kids").removeClass('show');
          $(".q2Kids").removeClass('show');
          $(".q3Kids").removeClass('show');$(".q5Kids").removeClass('show');$(".q6Kids").removeClass('show');
      ...
      $('.q5').click(function() {	  	$(".logoContainer").css('display','none');
        ...
        $(this).siblings().removeClass('active');
          ...
          $(".q1Kids").css('display','none');
          $(".q2Kids").css('display','none');
          $(".q3Kids").css('display','none');$(".q4Kids").css('display','none');$(".q6Kids").css('display','none');$(".q7Kids").css('display','none');
          
          $(".q1Kids").removeClass('show');
          $(".q2Kids").removeClass('show');
          $(".q3Kids").removeClass('show');$(".q4Kids").removeClass('show');$(".q6Kids").removeClass('show');$(".q7Kids").removeClass('show');
      ...
      $('.q6').click(function() {	   	$(".logoContainer").css('display','none');
        ...
        $(this).siblings().removeClass('active');
          ...
          $(".q1Kids").css('display','none');
          $(".q2Kids").css('display','none');
          $(".q3Kids").css('display','none');$(".q4Kids").css('display','none');$(".q5Kids").css('display','none');$(".q7Kids").css('display','none');
          
          $(".q1Kids").removeClass('show');
          $(".q2Kids").removeClass('show');
          $(".q3Kids").removeClass('show');$(".q4Kids").removeClass('show');$(".q5Kids").removeClass('show');$(".q7Kids").removeClass('show');
      ...
      $('.q7').click(function() {	    	
        $(".logoContainer").css('display','none');
         ...
         if ($(this).is(".q7.shrink")) { 
          ...
          $(".q1Kids").css('display','none');
          $(".q2Kids").css('display','none');
          $(".q3Kids").css('display','none');$(".q4Kids").css('display','none');$(".q5Kids").css('display','none');$(".q6Kids").css('display','none');
          
          $(".q1Kids").removeClass('show');
          $(".q2Kids").removeClass('show');
          $(".q3Kids").removeClass('show');$(".q4Kids").removeClass('show');$(".q5Kids").removeClass('show');$(".q6Kids").removeClass('show');
      ...
      $("#ccircle circle").click(function(){	
          ...
          $("#c1T").css('font-size','0.25em');
          $("#c2T").css('font-size','0.25em');
          $("#c3T").css('font-size','0.25em');
          $("#c4T").css('font-size','0.25em');
          $("#c5T").css('font-size','0.25em');
          $("#c6T").css('font-size','0.25em');
          $("#c7T").css('font-size','0.25em');
          //$(this).attr('r','12%');

          if(tit=="angerMeter"){
            $("#c1T").css('font-size','0.32em');
          $("#angerMeter").attr('cx','50%'); $("#angerMeter").attr('cy','15%');
          $("#guiltMeter").attr('cx','78%'); $("#guiltMeter").attr('cy','28%');
          $("#discontentMeter").attr('cx','85%'); $("#discontentMeter").attr('cy','55%');
          $("#envyMeter").attr('cx','68%'); $("#envyMeter").attr('cy','79%');
          $("#sadMeter").attr('cx','34%'); $("#sadMeter").attr('cy','79%');
          $("#anxietyMeter").attr('cx','15%'); $("#anxietyMeter").attr('cy','55%');
          $("#lonelinessMeter").attr('cx','22%'); $("#lonelinessMeter").attr('cy','28%');
          $(".angerMeter").attr('x','50%'); $(".angerMeter").attr('y','15%');
          $(".guiltMeter").attr('x','78%'); $(".guiltMeter").attr('y','28%');
          $(".discontentMeter").attr('x','85%'); $(".discontentMeter").attr('y','55%');
          $(".envyMeter").attr('x','68%'); $(".envyMeter").attr('y','79%');
          $(".sadMeter").attr('x','34%'); $(".sadMeter").attr('y','79%');
          $(".anxietyMeter").attr('x','15%'); $(".anxietyMeter").attr('y','55%');
          $(".lonelinessMeter").attr('x','22%'); $(".lonelinessMeter").attr('y','28%');
          $("#c7T").css('font-size','0.25em');
          $("#c6T").css('font-size','0.25em');
          $("#c1T").css('font-size','0.32em');
          $("#c2T").css('font-size','0.25em');
          ...
          if(tit=="guiltMeter"){
          $("#angerMeter").attr('cx','22%'); $("#angerMeter").attr('cy','28%');
          $("#guiltMeter").attr('cx','50%'); $("#guiltMeter").attr('cy','15%');
          $("#discontentMeter").attr('cx','78%'); $("#discontentMeter").attr('cy','28%');
          $("#envyMeter").attr('cx','85%'); $("#envyMeter").attr('cy','55%');
          $("#sadMeter").attr('cx','68%'); $("#sadMeter").attr('cy','79%');
          $("#anxietyMeter").attr('cx','34%'); $("#anxietyMeter").attr('cy','79%');
          $("#lonelinessMeter").attr('cx','15%'); $("#lonelinessMeter").attr('cy','55%');
          $(".angerMeter").attr('x','22%'); $(".angerMeter").attr('y','28%');
          $(".guiltMeter").attr('x','50%'); $(".guiltMeter").attr('y','15%');
          $(".discontentMeter").attr('x','78%'); $(".discontentMeter").attr('y','28%');
          $(".envyMeter").attr('x','85%'); $(".envyMeter").attr('y','55%');
          $(".sadMeter").attr('x','68%'); $(".sadMeter").attr('y','79%');
          $(".anxietyMeter").attr('x','34%'); $(".anxietyMeter").attr('y','79%');
          $(".lonelinessMeter").attr('x','15%'); $(".lonelinessMeter").attr('y','55%');
          $("#c7T").css('font-size','0.25em');
          $("#c6T").css('font-size','0.25em');
          $("#c1T").css('font-size','0.25em');
          $("#c2T").css('font-size','0.32em');
          $("#c3T").css('font-size','0.25em');
          $("#c4T").css('font-size','0.25em');
          $("#c5T").css('font-size','0.25em');
          }
          if(tit=="discontentMeter"){
            $("#angerMeter").attr('cx','15%'); $("#angerMeter").attr('cy','55%');
          $("#guiltMeter").attr('cx','22%'); $("#guiltMeter").attr('cy','28%');
          $("#discontentMeter").attr('cx','50%'); $("#discontentMeter").attr('cy','15%');
          $("#envyMeter").attr('cx','78%'); $("#envyMeter").attr('cy','28%');
          $("#sadMeter").attr('cx','85%'); $("#sadMeter").attr('cy','55%');
          $("#anxietyMeter").attr('cx','68%'); $("#anxietyMeter").attr('cy','79%');
          $("#lonelinessMeter").attr('cx','34%'); $("#lonelinessMeter").attr('cy','79%');
          $(".angerMeter").attr('x','15%'); $(".angerMeter").attr('y','55%');
          $(".guiltMeter").attr('x','22%'); $(".guiltMeter").attr('y','28%');
          $(".discontentMeter").attr('x','50%'); $(".discontentMeter").attr('y','15%');
          $(".envyMeter").attr('x','78%'); $(".envyMeter").attr('y','28%');
          $(".sadMeter").attr('x','85%'); $(".sadMeter").attr('y','55%');
          $(".anxietyMeter").attr('x','68%'); $(".anxietyMeter").attr('y','79%');
          $(".lonelinessMeter").attr('x','34%'); $(".lonelinessMeter").attr('y','79%');

          $("#c7T").css('font-size','0.25em');
          $("#c6T").css('font-size','0.25em');
          $("#c1T").css('font-size','0.25em');
          $("#c2T").css('font-size','0.25em');
          $("#c3T").css('font-size','0.32em');
          $("#c4T").css('font-size','0.25em');
          $("#c5T").css('font-size','0.25em');
            
          }
          if(tit=="envyMeter"){
            $("#angerMeter").attr('cx','34%'); $("#angerMeter").attr('cy','79%');
          $("#guiltMeter").attr('cx','15%'); $("#guiltMeter").attr('cy','55%');
          $("#discontentMeter").attr('cx','22%'); $("#discontentMeter").attr('cy','28%');
          $("#envyMeter").attr('cx','50%'); $("#envyMeter").attr('cy','15%');
          $("#sadMeter").attr('cx','78%'); $("#sadMeter").attr('cy','28%');
          $("#anxietyMeter").attr('cx','85%'); $("#anxietyMeter").attr('cy','55%');
          $("#lonelinessMeter").attr('cx','68%'); $("#lonelinessMeter").attr('cy','79%');
          $(".angerMeter").attr('x','34%'); $(".angerMeter").attr('y','79%');
          $(".guiltMeter").attr('x','15%'); $(".guiltMeter").attr('y','55%');
          $(".discontentMeter").attr('x','22%'); $(".discontentMeter").attr('y','28%');
          $(".envyMeter").attr('x','50%'); $(".envyMeter").attr('y','15%');
          $(".sadMeter").attr('x','78%'); $(".sadMeter").attr('y','28%');
          $(".anxietyMeter").attr('x','85%'); $(".anxietyMeter").attr('y','55%');
          $(".lonelinessMeter").attr('x','68%'); $(".lonelinessMeter").attr('y','79%'); 
          $("#c7T").css('font-size','0.25em');
          $("#c6T").css('font-size','0.25em');
          $("#c1T").css('font-size','0.25em');
          $("#c2T").css('font-size','0.25em');
          $("#c3T").css('font-size','0.25em');
          $("#c4T").css('font-size','0.32em');
          $("#c5T").css('font-size','0.25em');
          }
          if(tit=="sadMeter"){
            $("#angerMeter").attr('cx','68%'); $("#angerMeter").attr('cy','79%');
          $("#guiltMeter").attr('cx','34%'); $("#guiltMeter").attr('cy','79%');
          $("#discontentMeter").attr('cx','15%'); $("#discontentMeter").attr('cy','55%');
          $("#envyMeter").attr('cx','22%'); $("#envyMeter").attr('cy','28%');
          $("#sadMeter").attr('cx','50%'); $("#sadMeter").attr('cy','15%');
          $("#anxietyMeter").attr('cx','78%'); $("#anxietyMeter").attr('cy','28%');
          $("#lonelinessMeter").attr('cx','85%'); $("#lonelinessMeter").attr('cy','55%');
          $(".angerMeter").attr('x','68%'); $(".angerMeter").attr('y','79%');
          $(".guiltMeter").attr('x','34%'); $(".guiltMeter").attr('y','79%');
          $(".discontentMeter").attr('x','15%'); $(".discontentMeter").attr('y','55%');
          $(".envyMeter").attr('x','22%'); $(".envyMeter").attr('y','28%');
          $(".sadMeter").attr('x','50%'); $(".sadMeter").attr('y','15%');
          $(".anxietyMeter").attr('x','78%'); $(".anxietyMeter").attr('y','28%');
          $(".lonelinessMeter").attr('x','85%'); $(".lonelinessMeter").attr('y','55%');
          $("#c7T").css('font-size','0.25em');
          $("#c6T").css('font-size','0.25em');
          $("#c1T").css('font-size','0.25em');
          $("#c2T").css('font-size','0.25em');
          $("#c3T").css('font-size','0.25em');
          $("#c4T").css('font-size','0.25em');
          $("#c5T").css('font-size','0.32em');
          }
          if(tit=="anxietyMeter"){
            $("#angerMeter").attr('cx','85%'); $("#angerMeter").attr('cy','55%');
          $("#guiltMeter").attr('cx','68%'); $("#guiltMeter").attr('cy','79%');
          $("#discontentMeter").attr('cx','34%'); $("#discontentMeter").attr('cy','79%');
          $("#envyMeter").attr('cx','15%'); $("#envyMeter").attr('cy','55%');
          $("#sadMeter").attr('cx','22%'); $("#sadMeter").attr('cy','28%');
          $("#anxietyMeter").attr('cx','50%'); $("#anxietyMeter").attr('cy','15%');
          $("#lonelinessMeter").attr('cx','78%'); $("#lonelinessMeter").attr('cy','28%');
          $(".angerMeter").attr('x','85%'); $(".angerMeter").attr('y','55%');
          $(".guiltMeter").attr('x','68%'); $(".guiltMeter").attr('y','79%');
          $(".discontentMeter").attr('x','34%'); $(".discontentMeter").attr('y','79%');
          $(".envyMeter").attr('x','15%'); $(".envyMeter").attr('y','55%');
          $(".sadMeter").attr('x','22%'); $(".sadMeter").attr('y','28%');
          $(".anxietyMeter").attr('x','50%'); $(".anxietyMeter").attr('y','15%');
          $(".lonelinessMeter").attr('x','78%'); 
          $(".lonelinessMeter").attr('y','28%');
          $("#c6T").css('font-size','0.32em');
          $("#c1T").css('font-size','0.25em');
          $("#c2T").css('font-size','0.25em');
          $("#c3T").css('font-size','0.25em');
          $("#c4T").css('font-size','0.25em');
          ...
          $("#angerMeter").attr('cx','78%'); $("#angerMeter").attr('cy','28%');
          $("#guiltMeter").attr('cx','85%'); $("#guiltMeter").attr('cy','55%');
          $("#discontentMeter").attr('cx','68%'); $("#discontentMeter").attr('cy','79%');
          $("#envyMeter").attr('cx','34%'); $("#envyMeter").attr('cy','79%');
          $("#sadMeter").attr('cx','15%'); $("#sadMeter").attr('cy','55%');
          $("#anxietyMeter").attr('cx','22%'); $("#anxietyMeter").attr('cy','28%');
          $("#lonelinessMeter").attr('cx','50%'); $("#lonelinessMeter").attr('cy','15%');
          $(".angerMeter").attr('x','78%'); $(".angerMeter").attr('y','28%');
          $(".guiltMeter").attr('x','85%'); $(".guiltMeter").attr('y','55%');
          $(".discontentMeter").attr('x','68%'); $(".discontentMeter").attr('y','79%');
          $(".envyMeter").attr('x','34%'); $(".envyMeter").attr('y','79%');
          $(".sadMeter").attr('x','15%'); $(".sadMeter").attr('y','55%');
          $(".anxietyMeter").attr('x','22%'); $(".anxietyMeter").attr('y','28%');
          $(".lonelinessMeter").attr('x','50%'); $(".lonelinessMeter").attr('y','15%');
      ...
      $("#ccircle text").click(function(){	
          ...
          if(tit=="angerMeter"){ 
          $("#angerMeter").attr('stroke-opacity','1'); $("#angerMeter").attr('r','12%');
          $("#angerMeter").attr('cx','50%'); $("#angerMeter").attr('cy','15%');
          $("#c1T").css('font-size','0.32em');
          $("#guiltMeter").attr('cx','78%'); $("#guiltMeter").attr('cy','28%');
          $("#discontentMeter").attr('cx','85%'); $("#discontentMeter").attr('cy','55%');
          ...
          if(tit=="guiltMeter"){ 
            $("#c2T").css('font-size','0.32em');
            $("#guiltMeter").attr('stroke-opacity','1'); $("#guiltMeter").attr('r','12%');
          $("#angerMeter").attr('cx','22%'); $("#angerMeter").attr('cy','28%');
          $("#guiltMeter").attr('cx','50%'); $("#guiltMeter").attr('cy','15%');
          $("#discontentMeter").attr('cx','78%'); $("#discontentMeter").attr('cy','28%');
          $("#envyMeter").attr('cx','85%'); $("#envyMeter").attr('cy','55%');
          ...
          if(tit=="discontentMeter"){ 
            $("#c3T").css('font-size','0.32em');
            $("#discontentMeter").attr('stroke-opacity','1'); $("#discontentMeter").attr('r','12%');
            $("#angerMeter").attr('cx','15%'); $("#angerMeter").attr('cy','55%');
          $("#guiltMeter").attr('cx','22%'); $("#guiltMeter").attr('cy','28%');
          $("#discontentMeter").attr('cx','50%'); $("#discontentMeter").attr('cy','15%');
          $("#envyMeter").attr('cx','78%'); $("#envyMeter").attr('cy','28%');
          ...
          if(tit=="envyMeter"){ 
            $("#c4T").css('font-size','0.32em');
            $("#envyMeter").attr('stroke-opacity','1'); $("#envyMeter").attr('r','12%');
            $("#angerMeter").attr('cx','34%'); $("#angerMeter").attr('cy','79%');
          $("#guiltMeter").attr('cx','15%'); $("#guiltMeter").attr('cy','55%');
          $("#discontentMeter").attr('cx','22%'); $("#discontentMeter").attr('cy','28%');
          $("#envyMeter").attr('cx','50%'); $("#envyMeter").attr('cy','15%');
          ...
          if(tit=="sadMeter"){ 
            $("#c5T").css('font-size','0.32em');
            $("#sadMeter").attr('stroke-opacity','1');  $("#sadMeter").attr('r','12%');
            $("#angerMeter").attr('cx','68%'); $("#angerMeter").attr('cy','79%');
          $("#guiltMeter").attr('cx','34%'); $("#guiltMeter").attr('cy','79%');
          $("#discontentMeter").attr('cx','15%'); $("#discontentMeter").attr('cy','55%');
          $("#envyMeter").attr('cx','22%'); $("#envyMeter").attr('cy','28%');
          ...
          if(tit=="anxietyMeter"){ 
            $("#c6T").css('font-size','0.32em');
            $("#anxietyMeter").attr('stroke-opacity','1');  $("#anxietyMeter").attr('r','12%');
            $("#angerMeter").attr('cx','85%'); $("#angerMeter").attr('cy','55%');
          $("#guiltMeter").attr('cx','68%'); $("#guiltMeter").attr('cy','79%');
          $("#discontentMeter").attr('cx','34%'); $("#discontentMeter").attr('cy','79%');
          $("#envyMeter").attr('cx','15%'); $("#envyMeter").attr('cy','55%');
          ...
          $(".sadMeter").attr('x','22%'); $(".sadMeter").attr('y','28%');
          $(".anxietyMeter").attr('x','50%'); $(".anxietyMeter").attr('y','15%');
          $(".lonelinessMeter").attr('x','78%'); $(".lonelinessMeter").attr('y','28%');
            }
          if(tit=="lonelinessMeter"){ 
            $("#c7T").css('font-size','0.32em');
            $("#lonelinessMeter").attr('stroke-opacity','1'); $("#lonelinessMeter").attr('r','12%');
    ...
    // this.authService.getObject("observe_reload").then((data) => {
    //       console.log(data);
    //       if(data == null || data == false) {
    //         this.authService.setObject("observe_reload", true);
    //         this.authService.setObject("select_reload", false);
  ...
  select(){
    this.router.navigateByUrl('/think/select').then(()=>{window.location.reload()});
    //this.router.navigateByUrl('/think/select');
  }
