...
@Component({
  selector: 'app-reset-mindset-modal',
  templateUrl: './reset-mindset-modal.page.html',
  styleUrls: ['./reset-mindset-modal.page.scss'],
})
export class ResetMindsetModalPage implements OnInit {
