...
import { SelfTalkModalPage } from '../self-talk-modal/self-talk-modal.page';
declare var jQuery;


@Component({
  selector: 'app-self-talk',
  templateUrl: './self-talk.page.html',
  styleUrls: ['./self-talk.page.scss'],
})
export class SelfTalkPage implements OnInit {
