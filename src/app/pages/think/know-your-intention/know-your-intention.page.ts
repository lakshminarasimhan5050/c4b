...
@Component({
  selector: 'app-know-your-intention',
  templateUrl: './know-your-intention.page.html',
  styleUrls: ['./know-your-intention.page.scss'],
})
export class KnowYourIntentionPage implements OnInit {
   getClass : any;
   backgroundClass: any;
  constructor(
