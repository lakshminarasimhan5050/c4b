...
@Component({
  selector: 'app-reset-mindset',
  templateUrl: './reset-mindset.page.html',
  styleUrls: ['./reset-mindset.page.scss'],
})
export class ResetMindsetPage implements OnInit {

  constructor(public modalController: ModalController,private platform: Platform, private router: Router, private loadingctrl: LoadingController) { 
  ...
  ngOnInit() { }
dbrief(){
 this.router.navigateByUrl('/think/debrief').then(e=>{setTimeout(() => {
    console.log('Done');
  ...
  //this.router.navigateByUrl('/think/debrief')
}
