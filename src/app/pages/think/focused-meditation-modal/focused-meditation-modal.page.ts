...
@Component({
  selector: 'app-focused-meditation-modal',
  templateUrl: './focused-meditation-modal.page.html',
  styleUrls: ['./focused-meditation-modal.page.scss'],
})
export class FocusedMeditationModalPage implements OnInit {
