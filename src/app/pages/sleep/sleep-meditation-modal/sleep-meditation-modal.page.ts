...
@Component({
  selector: 'app-sleep-meditation-modal',
  templateUrl: './sleep-meditation-modal.page.html',
  styleUrls: ['./sleep-meditation-modal.page.scss'],
})
export class SleepMeditationModalPage implements OnInit {
