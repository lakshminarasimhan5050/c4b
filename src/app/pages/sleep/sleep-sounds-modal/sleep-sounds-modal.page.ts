...
@Component({
  selector: 'app-sleep-sounds-modal',
  templateUrl: './sleep-sounds-modal.page.html',
  styleUrls: ['./sleep-sounds-modal.page.scss'],
})
export class SleepSoundsModalPage implements OnInit {
