...
@Component({
  selector: 'app-sleep-tips-modal',
  templateUrl: './sleep-tips-modal.page.html',
  styleUrls: ['./sleep-tips-modal.page.scss'],
})
export class SleepTipsModalPage implements OnInit {
