...
@Component({
  selector: 'app-one-the-job-modal',
  templateUrl: './one-the-job-modal.page.html',
  styleUrls: ['./one-the-job-modal.page.scss'],
})
export class OneTheJobModalPage implements OnInit {
