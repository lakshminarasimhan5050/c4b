...
@Component({
  selector: 'app-your-stats-modal',
  templateUrl: './your-stats-modal.page.html',
  styleUrls: ['./your-stats-modal.page.scss'],
})
export class YourStatsModalPage implements OnInit {
